...
class Comment extends React.Component {
  constructor(props) {
    ...
    this.state = {
      comments: this.props.commentData.type === 'comment' ? this.props.comments[this.props.commentData.type][this.props.commentData.parent] : this.props.comments[this.props.commentData.type][this.props.commentData.videoId][this.props.commentData.parent],
      comment: this.props.commentData,
      user: this.props.users[this.props.commentData.user]
    }
  }
  ...
  render() {
    ...
    return (
      <div className="box">
        ...
        {this.state.comments[elId].reply && commentData.reply &&
          <Replies reply={this.state.comments[elId].reply} comment={this.state.comments[elId]} />
        }
      </div>
    );
  }
